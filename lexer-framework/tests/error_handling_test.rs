...
fn test_position_accuracy() {
    ...
    let token_a = tokens.iter().find(|t| matches!(t, TestToken::Char { ch: 'a', .. }));
    ...
    let token_d = tokens.iter().find(|t| matches!(t, TestToken::Char { ch: 'd', .. }));
    ...
    let token_g = tokens.iter().find(|t| matches!(t, TestToken::Char { ch: 'g', .. }));
