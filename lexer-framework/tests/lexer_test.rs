...
fn test_lexer_priority() {
    ...
    let rules: RuleSet<TestToken> = vec![Box::new(BRule), Box::new(ARule)]; // BRule added first, but ARule has higher priority
    let mut lexer = Lexer::from_str("a", rules);
...
#[test]
fn test_lexer_eof() {
    let rules: RuleSet<TestToken> = vec![Box::new(ARule), Box::new(EofRule)];
    let mut lexer = Lexer::from_str("a", rules);
...
fn test_lexer_tokenize() {
    let rules: RuleSet<TestToken> = vec![Box::new(ARule), Box::new(BRule), Box::new(EofRule)];
    let mut lexer = Lexer::from_str("ab", rules);
...
fn test_lexer_empty_input() {
    let rules: RuleSet<TestToken> = vec![Box::new(EofRule)];
...
fn test_lexer_rule_without_quick_check() {
    ...
    let rules: RuleSet<TestToken> = vec![Box::new(CRule)];
...
fn test_lexer_checkpoint_restore() {
    ...
    let rules: RuleSet<TestToken> = vec![Box::new(FailingRule), Box::new(ARule)];
    let mut lexer = Lexer::from_str("a", rules);
